...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> HBT -Detalles del paquete</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
				...
				<ul>
					...
					<button type="submit" name="submit2" class="btn-primary btn">Reservar</button>
						...
						<?php } else {?>
							...
							<a href="#" data-toggle="modal" data-target="#myModal4" class="btn-primary btn" > Reservar</a></li>
							<?php } ?>
					<div class="clearfix"></div>
				</ul>
			</div>

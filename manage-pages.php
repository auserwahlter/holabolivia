...
$query -> execute();
$msg="Datos de la página actualizados exitosamente";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Inicio</a><i class="fa fa-angle-right"></i>Actualizar datos de la página </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Update Page Data</h3>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Seleccionar página</label>
									<div class="col-sm-8">
									   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***Seleccionar una***</option>
                  ...
                  <option value="manage-pages.php?type=aboutus">acerca de nosotros</option> 
                  <option value="manage-pages.php?type=contact">Contactanos</option>
                </select>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Página seleccionada</label>
									<div class="col-sm-8">
									<?php
